...
public class InviteFriendsActivity extends BaseActivity implements ContactsAdapter.ContactsAdapterListener{
        ...
        protected Void doInBackground(Void... voids) {
            ...
            if (phones != null) {
                ...
                if (phones.getCount() == 0) {
                    Toast.makeText(InviteFriendsActivity.this, "No contacts in your contact list.", Toast.LENGTH_LONG).show();
                }
